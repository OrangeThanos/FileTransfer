...
conan_package_library_targets("${asio-grpc_LIBS_RELEASE}"    # libraries
                              ...
                              "${asio-grpc_BIN_DIRS_RELEASE}" # package_bindir
                              "${asio-grpc_LIBRARY_TYPE_RELEASE}"
                              "${asio-grpc_IS_HOST_WINDOWS_RELEASE}"
                              asio-grpc_DEPS_TARGET
                              asio-grpc_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "asio-grpc"    # package_name
                              "${asio-grpc_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET asio-grpc::asio-grpc
                 ...
                 $<$<CONFIG:Release>:${asio-grpc_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET asio-grpc::asio-grpc
