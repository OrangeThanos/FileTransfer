...
conan_package_library_targets("${re2_LIBS_RELEASE}"    # libraries
                              ...
                              "${re2_BIN_DIRS_RELEASE}" # package_bindir
                              "${re2_LIBRARY_TYPE_RELEASE}"
                              "${re2_IS_HOST_WINDOWS_RELEASE}"
                              re2_DEPS_TARGET
                              re2_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "re2"    # package_name
                              "${re2_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET re2::re2
                 ...
                 $<$<CONFIG:Release>:${re2_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET re2::re2
