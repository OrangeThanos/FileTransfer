...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT gRPC::grpcpp_channelz #############
        ...
        set_property(TARGET gRPC::grpcpp_channelz PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpcpp_channelz_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc++_reflection #############
        ...
        set_property(TARGET gRPC::grpc++_reflection PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc++_reflection_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc++_unsecure #############
        ...
        set_property(TARGET gRPC::grpc++_unsecure PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc++_unsecure_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc_unsecure #############
        ...
        set_property(TARGET gRPC::grpc_unsecure PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc_unsecure_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc++_error_details #############
        ...
        set_property(TARGET gRPC::grpc++_error_details PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc++_error_details_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc++_alts #############
        ...
        set_property(TARGET gRPC::grpc++_alts PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc++_alts_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc++ #############
        ...
        set_property(TARGET gRPC::grpc++ PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc++_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc #############
        ...
        set_property(TARGET gRPC::grpc PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET gRPC::grpc PROPERTY INTERFACE_COMPILE_DEFINITIONS
    ...
    ########## COMPONENT gRPC::gpr #############
        ...
        set_property(TARGET gRPC::gpr PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_gpr_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT grpc::grpc_execs #############
        ...
        set_property(TARGET grpc::grpc_execs PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_grpc_grpc_execs_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::grpc_plugin_support #############
        ...
        set_property(TARGET gRPC::grpc_plugin_support PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_grpc_plugin_support_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::upb #############
        ...
        set_property(TARGET gRPC::upb PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_upb_LIB_DIRS_RELEASE}> APPEND)
    ...
    ########## COMPONENT gRPC::address_sorting #############
        ...
        set_property(TARGET gRPC::address_sorting PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${grpc_gRPC_address_sorting_LIB_DIRS_RELEASE}> APPEND)
